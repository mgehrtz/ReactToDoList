...
class ToDoList extends React.Component {
    ...
    handleSubmit(event) {
        ...
        fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=279", {
            method: "POST",
            mode: "cors",
    ...
    deleteTask(id) {
        ...
        fetch(`https://altcademy-to-do-list-api.herokuapp.com/tasks/${id}?api_key=279`, {
            method: "DELETE",
            mode: "cors",
        }).then(checkStatus)
          .then(json)
    ...
    toggleComplete(id, completed) {
        ...
        fetch(`https://altcademy-to-do-list-api.herokuapp.com/tasks/${id}/mark_${newState}?api_key=279`, {
            method: "PUT",
            mode: "cors",
        }).then(checkStatus)
          .then(json)
...
class Task extends React.Component {
    render () {
        ...
        return (
            <div className="row mb-3 p-2 bg-light">
                <p className="col m-0">{content}</p>
                <button
                    onClick={() => onDelete(id)}
